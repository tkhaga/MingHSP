...
;SWFAction
	...
	#deffunc s_setLine int wid,int r,int g,int b,int a
	...
	#deffunc s_addSolidFill var item,int r,int g,int b,int a
	...
	#deffunc SWFAction_load str action,var obj,int size
